        ...
        ConnectionMonitor
{
     ...
     * @param htmlSource
     */
    public void setConnection (String htmlSource){
    	setLexer( new Lexer(htmlSource) );
    }
            ...
            ParserException
    {
        if ( (null != url) && !"".equals (url) ){
        	...
        	ConnectionManager cb = getConnectionManager();
        	URLConnection uc = cb.openConnection(url);
        	if(uc == null){
        		setConnection(url);
        	}
        	else{
